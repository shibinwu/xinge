  ...
  $(function() {
      ...
      $("#SUO").click(function() {
          ...
          if(p){
              $('.DL').show();
              $('#list').children().children('.last').addClass('DJBK').children('a').addClass('DJBL'); //那么就显示div
              p = 0;
          }else{
              $('.DL').hide();
              $('#list').children().children('.last').removeClass('DJBK').children('a').removeClass('DJBL'); //那么就显示div
              p = 1;
          }
      });
      // 点击飞机的X隐藏
      ...
      $('#DL').click(function() { //点击标签
         if(l == 0){
             $(this).addClass('DJBK');
             $(this).children('a').addClass('DJBL');
             $('.DL').show(); //那么就显示div
             l =1;
         }else{
             $(this).removeClass('DJBK');
             $(this).children('a').removeClass('DJBL');
             $('.DL').hide(); //就隐藏div
             l=0;
         }
      })
